...
const Pagination = ({
  ...
  return (
    <div className="flex items-center justify- bg-white px-4 py-3 sm:px-6 rounded-bl-2xl rounded-br-2xl dark:border-gray-800 dark:bg-white/[0.03]">
